...
def go_repositories():
    ...
    go_repository(
        ...
        sum = "h1:i0ZbOQocHUjfFasBiUql5zVeC7u/vahFd96DFA8UOWk=",
        version = "v3.0.9",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:FTYVIEzY/bfl37lu3pR4lIj+F9Vp1jE8oh91VmxKgLo=",
        version = "v1.0.11",
    )
    go_repository(
    ...
    go_repository(
        name = "com_github_hashicorp_go_secure_stdlib_plugincontainer",
        importpath = "github.com/hashicorp/go-secure-stdlib/plugincontainer",
        sum = "h1:lNWQ5KVsLmzjvN11LYqaTXtMrCP7CyxfmTeR3h0l3s8=",
        version = "v0.2.2",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:0UEOLhFyoEMpb/r8H5qyOu58A/j35pncqiS/d+ORKYk=",
        version = "v0.10.2",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:/WYFbB1NtMtoMxCbqpzzTFPDkxxlLTPme390KEGaEPc=",
        version = "v1.4.3",
    )
    go_repository(
